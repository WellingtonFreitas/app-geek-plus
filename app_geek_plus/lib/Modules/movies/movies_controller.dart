...
class MoviesController extends GetxController with MessagesMixin {
  ...
  MoviesController({
    ...
    }): _genresService = genresService, _moviesService = moviesService, _authService = authService;
  ...
  Future<void> favoriteMovie(MovieModel movie) async {
    ...
    if(user != null){
      var nrewMovie = movie.copyWith(favorite: !movie.favorite);
      await _moviesService.addOrRemoveFavorite(user.uid, nrewMovie);
      await getMovies();
    }
  }
